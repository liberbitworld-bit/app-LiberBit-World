...
//
// IMPORTANTE: imports estáticos top-level. Dinámicos (await import)
// no son detectados por el bundler de Vercel y el módulo no se
// incluye en el lambda → 502 silencioso.
// @noble/secp256k1 v1.7.x: single-file pure JS con schnorr.
// sha256 vía node:crypto.
// ============================================================
...
async function buildNip98Token(skBytes, url, method) {
...
export default async function handler(req, res) {
    ...
    async function authedGet(url) {
        const token = await buildNip98Token(skBytes, url, 'GET');
