        ...
        modal.innerHTML = `
            <div style="background:var(--color-bg-card);border:2px solid var(--color-border);border-radius:20px;padding:1.5rem;width:100%;max-width:700px;margin:auto;position:relative;">
                ...
                <div style="display:flex;gap:0.5rem;margin-bottom:1rem;flex-wrap:wrap;">
                    ...
                    <button onclick="LBW_Stalls.showEditStallForm();document.getElementById('stallDetailModal').remove();" style="padding:0.4rem 1rem;background:rgba(44,95,111,0.2);border:1px solid var(--color-teal-light);border-radius:8px;color:var(--color-teal-light);cursor:pointer;font-size:0.8rem;">✏️ Editar tienda</button>
                </div>` : ''}
