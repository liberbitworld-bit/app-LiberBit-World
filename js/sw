...
// Estrategia: network-first para HTML y JS versionados, cache-first para iconos/CSS
...
// Nota: JS con ?v= params se cachean automáticamente por URL completa.
// config.js y nostr.js se excluyen del pre-cache para evitar versiones obsoletas.
