:root {
        ...
        * {
        ...
        .hero-header {
            display: none; /* auth buttons now live in hero-body */
        }
        ...
        .hero-orb-1 {
            width: 600px;
            height: 600px;
            background: radial-gradient(circle, rgba(229, 185, 92, 0.18) 0%, transparent 70%);
            top: -100px;
            right: -100px;
        ...
        .hero-orb-2 {
            width: 500px;
            height: 500px;
            background: radial-gradient(circle, rgba(44, 95, 111, 0.35) 0%, transparent 70%);
            bottom: -80px;
            left: -80px;
        ...
        .hero-orb-3 {
            width: 350px;
            height: 350px;
            background: radial-gradient(circle, rgba(61, 117, 133, 0.2) 0%, transparent 70%);
            top: 50%;
            left: 55%;
        ...
        .hero-grid-overlay {
            ...
            inset: 0;
            background-image:
                linear-gradient(rgba(229, 185, 92, 0.04) 1px, transparent 1px),
                linear-gradient(90deg, rgba(229, 185, 92, 0.04) 1px, transparent 1px);
        ...
        .hero-eyebrow-dot {
            ...
            background: var(--color-gold);
            border-radius: 50%;
            box-shadow: 0 0 8px rgba(229, 185, 92, 0.9);
        ...
        .hero-title em {
            font-style: italic;
            background: linear-gradient(100deg, var(--color-gold) 20%, #f0d090 60%, var(--color-teal-light) 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }
        ...
        .hero-sub {
            ...
            animation: heroReveal 1s 0.35s cubic-bezier(0.22, 1, 0.36, 1) both;
        }
        ...
        .hero-pills {
            ...
            justify-content: center;
            margin-bottom: 3rem;
            animation: heroReveal 1s 0.45s cubic-bezier(0.22, 1, 0.36, 1) both;
        }
        ...
        .hero-cta-row {
            ...
            align-items: center;
            flex-wrap: wrap;
            animation: heroReveal 1s 0.55s cubic-bezier(0.22, 1, 0.36, 1) both;
        }
        ...
        .hero-cta-primary {
            ...
            border-radius: 14px;
            cursor: pointer;
            box-shadow: 0 0 0 0 rgba(229, 185, 92, 0.5);
            transition: all 0.3s ease;
            animation: ctaGlow 3s 2s ease-in-out infinite;
        }

        @keyframes ctaGlow {
            0%, 100% { box-shadow: 0 4px 20px rgba(229, 185, 92, 0.35); }
            50%       { box-shadow: 0 4px 40px rgba(229, 185, 92, 0.65); }
        }

        .hero-cta-primary:hover {
            transform: translateY(-3px) scale(1.02);
            box-shadow: 0 8px 32px rgba(229, 185, 92, 0.55) !important;
        }
        ...
        .hero-ring {
            ...
            height: 700px;
            border-radius: 50%;
            border: 1px solid rgba(229, 185, 92, 0.07);
            pointer-events: none;
            z-index: 0;
        ...
        .hero-ring::before {
            ...
            inset: 40px;
            border-radius: 50%;
            border: 1px solid rgba(61, 117, 133, 0.1);
        }
        ...
        /* ══════════════════════════════════════════════════════════════
           CHAT SECTION — Phase 1 Telegram-Style Redesign
           ══════════════════════════════════════════════════════════════ */
        ...
        .chat-sidebar-tab .indicator-item {
            position: absolute;
            top: 6px;
            right: 12px;
            font-size: 0.6rem;
        ...
        .chat-search-bar .join {
            border-radius: 10px;
            overflow: hidden;
        }

        .chat-search-bar .join .input {
            background: var(--color-bg-dark);
        ...
        .chat-search-bar .join .input:focus {
            border-color: var(--color-gold);
            outline: none;
            box-shadow: 0 0 0 2px rgba(229, 185, 92, 0.15);
        }

        .chat-search-bar .join .btn {
            border-color: var(--color-border);
        }
        ...
        /* postsList: contenedor de mensajes comunitarios */
        #postsList {
            display: flex;
            flex-direction: column;
            gap: 0;
        ...
        .chat-message-mine {
            background: rgba(229, 185, 92, 0.08);
            border: 1px solid rgba(229, 185, 92, 0.15);
        }
        ...
        /* DM bubbles (DaisyUI chat classes) */
        .chat.chat-start,
        .chat.chat-end {
            padding: 2px 12px;
            margin-bottom: 2px;
        ...
        .chat-main-compose textarea::placeholder {
            color: var(--color-text-secondary);
            opacity: 0.7;
        }
        ...
        .chat-main-compose textarea:focus {
            outline: none;
            border-color: var(--color-gold);
            box-shadow: 0 0 0 2px rgba(229, 185, 92, 0.12);
        }
        ...
        .chat-send-btn {
            ...
            flex-shrink: 0;
            transition: all 0.2s ease;
            box-shadow: 0 2px 8px rgba(229, 185, 92, 0.25);
        }
        ...
        .debate-message:hover {
            background: rgba(229, 185, 92, 0.03);
        }
        .debate-message-mine .sidebar-conv-avatar {
        ...
        .proposal-status.quorum-failed {
            background: rgba(250, 173, 20, 0.15);
            color: #faad14;
            border: 1px solid #faad14;
        }

        .proposal-status.in-execution {
        ...
        .proposal-card.quorum-failed {
            border-color: rgba(250, 173, 20, 0.3);
            opacity: 0.85;
        }

        .proposal-card.in-execution {
